...
{
    public class GetAllBusinessImpactAnalysisForRiskChampionHeadEndpointTest
    {
        [Test]
        public async Task CallMethod_ReturnsListOfBIAForRiskChampionHead()
        {
            ...
            biaUnits[0].UpdateStage(BIAStage.RiskChampionHeadInitiateBIA);
            ...
            //// Act
            //var result = await GetAllBusinessImpactAnalysisForRiskChampionHeadEndpoint.HandleAsync(biaUnitRepo);
