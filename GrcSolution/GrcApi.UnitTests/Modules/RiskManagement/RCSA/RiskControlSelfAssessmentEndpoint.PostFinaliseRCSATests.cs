...
{
    internal class RiskControlSelfAssessmentEndpointPostFinaliseRCSATests
    {
        [Test]
        public async Task CallWithValidPayload_FinalizeRCSA()
        {
            // Arrange
            ...
            //// Act
            //var result = await RiskControlSelfAssessmentEndpointPostFinaliseRCSA.HandleAsync(approveDto, docRepo, documentProcessLogRepo);
            ...
            //Assert.That(docProcess.Status, Is.EqualTo(RCSAStatus.Treated));
            //Assert.That(docProcess.RCSAStage, Is.EqualTo(Stage.End));
        }
    }
}
