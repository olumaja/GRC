...
{
    public class RiskControlSelfAssessmentEndpointGetAllRCSAForRiskManagementToApplyTestTests
    {
        [Test]
        public async Task CallMethod_ReturnsListOfRCSAForRiskManagement()
        {
            // Arrange
            ...
            List<RiskControlSelfAssessmentUnit> rcsaUnits = new()
            {
                ...
                RiskControlSelfAssessmentUnit.Create(units[1].Id, documentRSCAProcess: Create(Stage.RiskManagementEnterTestToBeApplied)),
            ...
            PagedResult<GetAllRCSAForRiskChampionDto> expectedRCSAUnitResult = rcsaUnitRepo
                .GetAllPaged(0, 0, t => t
                .Where(r => r.DocumentRSCAProcess.RCSAStage == Stage.RiskManagementEnterTestToBeApplied)
            ...
            ////Act
            //var response = await RiskControlSelfAssessmentEndpointGetAllRCSAForRiskManagementToApplyTest.HandleAsync(rcsaUnitRepo);
