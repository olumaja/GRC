...
{
    internal class RiskControlSelfAssessmentEndpointPostApproveReviewedTestAppliedTests
    {
        [Test]
        public async Task CallWithValidPayload_ApproveAndMoveRCSAToRiskManagementToFinalize()
        {
            // Arrange
            ...
            //// Act
            //var result = await RiskControlSelfAssessmentEndpointPostApproveReviewedTestApplied.HandleAsync(approveDto, docRepo, documentProcessLogRepo);
            ...
            //Assert.That(docProcess.RCSAStage, Is.EqualTo(Stage.RiskManagementFinal));
        }
    }
}
