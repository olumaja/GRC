...
{
    public class RiskControlSelfAssessmentEndpointGetAllRCSAForRiskChampionToReviewTestAppliedTests
    {
        [Test]
        public async Task CallMethod_ReturnsListOfRCSAForRiskChampionToReviewTestAppliedTests()
        {
            ...
            {
                RiskControlSelfAssessmentUnit.Create(units[0].Id, documentRSCAProcess: Create(Stage.RiskChampionReviewTestApplied)),
            ...
            PagedResult<GetAllRCSAForRiskChampionDto> expectedRCSAUnitResult = rcsaUnitRepo
                .GetAllPaged(0, 0, t => t
                .Where(r => r.DocumentRSCAProcess.RCSAStage == Stage.RiskChampionReviewTestApplied)
            ...
            ////Act
            //var response = await RiskControlSelfAssessmentEndpointGetAllRCSAForRiskChampionReviewTestApplied.HandleAsync(rcsaUnitRepo);
