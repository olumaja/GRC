...
{
    public class RiskControlSelfAssessmentEndpointGetAllRCSAForRiskChampionHeadReviewTestApplied
    {
        public static async Task<IResult> HandleAsync(IRepository<RiskControlSelfAssessmentUnit> repository, ClaimsPrincipal user, ICurrentUserService currentUserService)
        {
			try
			{
                ...
                List<GetAllRCSAForRiskChampionDto> rcsaList = new();
                ...
                rcsaList = repository
                    ...
                    .Include(e => e.DocumentRSCAProcess).Where(r => r.DocumentRSCAProcess.RCSAStage == DocumentRSCAProcess.Stage.RiskChampionHeadReviewTestApplied)
