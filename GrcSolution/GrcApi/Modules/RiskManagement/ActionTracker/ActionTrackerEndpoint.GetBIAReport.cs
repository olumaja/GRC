...
namespace Arm.GrcApi.Modules.RiskManagement.ActionTracker
{
    ...
    */
    public class ActionTrackerEndpointGetBIAReport
    {
        /// <summary>
        /// The endpoint get BIA report within specified date range
        /// </summary>
        ...
        public static async Task<IResult> HandleAsync(
             Guid unitId, DateOnly startDate, DateOnly endDate, IRepository<BusinessImpactAnalysis> biaRepo, IRepository<BusinessImpactAnalysisUnit> biaUnitRepo,
        ...
        )
        {
            try
            {
                ...
                foreach (var bia in biaReport)
                {
                    ...
                    {
                        if (!idOfUnitWithSameName.Contains(biaUnit.UnitId))
                            continue;
