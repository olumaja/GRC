...
namespace Arm.GrcApi.Modules.RiskManagement.AuditPlan
{
  ...
  * Endpoint to approve Engagement Letter
  */
    public class ApproveEngagementLetterEndpoint
    {
        ...
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(ApproveEngagementLetterRequest payload, IRepository<EngagementLetterAuditExecution> engagement, 
        ...
        )
        {
            try
            {
                ...
                var getEngagementLetter = engagement.GetContextByConditon(x => x.CommenceEngagementAuditexecutionId == getCommenceEng.Id && x.Team == payload.Team).FirstOrDefault();
                ...
                if (getEngagementLetter != null)
                {
                    getEngagementLetter.ApproveEngagementLetterStatus();
                    engagement.SaveChanges();
                    ...
                    string bodyOfficer = $"Dear {getAuditAnnouncementMemo.RequesterName},<br> {requesterName} has approved the Engagement Letter for {getAuditAnnouncementMemo.Unit} {getAuditAnnouncementMemo.Recommendation}, for your review and approval.<br><br>Please click the following link <a href={linkToGRCTool}>GRC link</a> to view the assessment.<br><br>Thank you";
    ...
    public record ApproveEngagementLetterRequest(Guid CommenceEngagementId, string Team);

    public class ApproveEngagementLetterRequestValidation : AbstractValidator<ApproveEngagementLetterRequest>
    {
        public ApproveEngagementLetterRequestValidation()
        {
