...
*/
    public class RejectARMSecurityBusinessRiskRatingEndpoint
    {

        /// <summary>
        /// Endpoint to reject armsecurity business risk rating
        /// </summary>
        /// <param name="businessriskratingId"></param>
        /// <param name="repo"></param>
        /// <param name="user"></param>
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(Guid businessriskratingId, IRepository<ARMSecurityRating> repo,
