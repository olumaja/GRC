...
*/
    public class RejectARMHoldingCompanyBusinessRiskRatingEndpoint
    {

        /// <summary>
        /// Endpoint to reject armholdingcompany business risk rating
        /// </summary>
        /// <param name="businessriskratingId"></param>
        /// <param name="repo"></param>
        /// <param name="user"></param>
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(Guid businessriskratingId, IRepository<ARMHoldingCompanyBusinessRating> repo,
             ...
             ClaimsPrincipal user)
        {
            try
            {
                ...
                {
                    getBusinessRiskRating.RejectARMHoldingCompanyBusinessRating();
                    repo.SaveChanges();
