...
{
    public class ARMSecurityRequest
    {
        public ARMSecurityRatingReq ARMSecurity { get; set; }
    }

    public class ARMSecurityRatingReq
    {
        public StrategySecurityReq Strategy { get; set; }
        public OperationSecurityReq Operations { get; set; }
        public FinancialSecurityReportingReq FinancialReporting { get; set; }
        public ComplianceSecurityReq Compliance { get; set; }
        public TimeSinceLastSecurityAuditReq LastReportOverallRating { get; set; }
        public BusinessRiskRatingStatus Status { get; set; }

    }
    public class StrategySecurityReq
    {
        public StrategySecurityRatingReq StockBroking { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class StrategySecurityRatingReq
    {
    ...
    public class OperationSecurityReq
    {
        public OperationSecurityRatingReq StockBroking { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class OperationSecurityRatingReq
    {
    ...
    public class FinancialSecurityReportingReq
    {
       // public FinacialSecurityRatingReq InvestmentBanking { get; set; }
        public FinacialSecurityRatingReq StockBroking { get; set; }
      //  public FinacialSecurityRatingReq Research { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class FinacialSecurityRatingReq
    {
    ...
    public class ComplianceSecurityReq
    {

        public ComplianceSecurityRatingReq StockBroking { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }

    }

    public class ComplianceSecurityRatingReq
    {
    ...
    public class TimeSinceLastSecurityAuditReq
    {
