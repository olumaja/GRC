 ...
 */
    public class ViewArmIMAudiPlanExecutionOfficerByIdEndpoint
    {
        /// <summary>
        ...
        public static async Task<IResult> HandleAsync(Guid anualAuditUniverseId, IRepository<AnualAuditUniverseRiskRating> annualaudit,
            ...
            IRepository<AuditUniverseARMIMResearch> research, IRepository<AuditUniverseARMIMFundAccount> fundAccount, IRepository<CommenceEngagementAuditexecution> commenceEng, ICurrentUserService currentUserService,
            ClaimsPrincipal user)
        {
            try
            {
                ...
                var getCommenceEng = commenceEng.GetContextByConditon(x => x.AnualAuditUniverseRiskRatingId == getAuditRating.AnualAuditUniverseRiskRatingId && x.Team == "IMUnit").FirstOrDefault();
                ...
                var engagementPlanOPC = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanOPC = getCommenceEngOPC.EngagementPlan.ToString();
                ...
                var engagementPlanReg = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanReg = getCommenceEngReg.EngagementPlan.ToString();
                ...
                var engagementPlanBD = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanBD = getCommenceEngBD.EngagementPlan.ToString();
                ...
                var engagementPlanOPS = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanOPS = getCommenceEngOPS.EngagementPlan.ToString();
                ...
                var engagementPlanFACC = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanFACC = getCommenceEngFACC.EngagementPlan.ToString();
                ...
                var engagementPlanFAD = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanFAD = getCommenceEngFAD.EngagementPlan.ToString();
                ...
                var engagementPlanROP = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanROP = getCommenceEngROP.EngagementPlan.ToString();
                ...
                var engagementPlanResearch = BusinessRiskRatingStatus.Pending.ToString();
                ...
                var getCommenceEngResearch = commenceEng.GetContextByConditon(x => x.AnualAuditUniverseRiskRatingId == getAuditRating.AnualAuditUniverseRiskRatingId && x.Team == "Retail Operation").FirstOrDefault();
                if (getCommenceEngResearch != null)
                {
                    engagementPlanResearch = getCommenceEngResearch.EngagementPlan.ToString();
                ...
                {
                    month = "January";
                    recommendation = getimunit.January ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.February))
                {
                    month = "February";
                    recommendation = getimunit.February ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.March))
                {
                    month = "March";
                    recommendation = getimunit.March ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.April))
                {
                    month = "April";
                    recommendation = getimunit.April ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.May))
                {
                    month = "May";
                    recommendation = getimunit.May ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.June))
                {
                    month = "June";
                    recommendation = getimunit.June ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.July))
                {
                    month = "July";
                    recommendation = getimunit.July ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.August))
                {
                    month = "August";
                    recommendation = getimunit.August ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.September))
                {
                    month = "September";
                    recommendation = getimunit.September ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.October))
                {
                    month = "October";
                    recommendation = getimunit.October ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.November))
                {
                    month = "November";
                    recommendation = getimunit.November ?? "Full Scope";
                }
                if (!string.IsNullOrEmpty(getimunit.December))
                {
                    month = "December";
                    recommendation = getimunit.December ?? "Full Scope";
                }

                var getoperationControl = operationControl.GetContextByConditon(x => x.ARMIMAuditUniverseId == getAuditRating.Id).FirstOrDefault();
                string monthOp = "January";
                string recommendationOp = "Full Scope";
                ...
                string monthReg = "January";
                string recommendationReg = "Full Scope";
                ...
                string monthBD = "January";
                string recommendationBD = "Full Scope";
                ...
                string monthSet = "January";
                string recommendationSet = "Full Scope";
                ...
                string monthAdm = "January";
                string recommendationAdm = "Full Scope";
                ...
                string monthAcct = "January";
                string recommendationAcct = "Full Scope";
                ...
                string monthRetail = "January";
                string recommendationRetail = "Full Scope";
                ...
                {                  
                    ...
                    OperationControl = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanOPC,
                    ...
                    Registrar = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanReg,
                    ...
                    BDPWMIAMIMRetail = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanBD,
                    ...
                    OperationSettlement = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanOPS,
                    ...
                    FundAdmin = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanFAD,
                    ...
                    FundAccount = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanFACC,
                    ...
                    RetailOperation = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanROP,
                    ...
                    Research = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanResearch,
