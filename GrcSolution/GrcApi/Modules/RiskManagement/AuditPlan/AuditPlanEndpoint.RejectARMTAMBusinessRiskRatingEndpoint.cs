 ...
 */
    public class RejectARMTAMBusinessRiskRatingEndpoint
    {

        /// <summary>
        /// Endpoint to reject armtam business risk rating
        /// </summary>
        /// <param name="businessriskratingId"></param>
        /// <param name="repo"></param>
        /// <param name="user"></param>
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(Guid businessriskratingId, IRepository<ARMTAMBusinessRiskRating> repo,
