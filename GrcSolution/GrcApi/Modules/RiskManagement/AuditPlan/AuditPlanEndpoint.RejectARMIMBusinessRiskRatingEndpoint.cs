 ...
 */
    public class RejectARMIMBusinessRiskRatingEndpoint
    {

        /// <summary>
        /// Endpoint to reject armim business risk rating
        /// </summary>
        /// <param name="businessriskratingId"></param>
        /// <param name="repo"></param>
        /// <param name="user"></param>
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(Guid businessriskratingId, IRepository<ARMIMBusinessRiskRating> repo,
