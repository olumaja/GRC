...
{
    public class ARMAgribusinessRequest
    {
        public ARMAgribusinessRatingReq ARMAgribusiness { get; set; }
    }
    public class ARMAgribusinessRatingReq
    {
        public StrategyAgribusinessReq Strategy { get; set; }
        public OperationAgribusinessReq Operations { get; set; }
        public FinancialAgribusinessReportingReq FinancialReporting { get; set; }
        public ComplianceAgribusinessReq Compliance { get; set; }
        public TimeSinceLastAgribusinessAuditReq LastReportOverallRating { get; set; }
        public BusinessRiskRatingStatus Status { get; set; }
    }
    public class StrategyAgribusinessReq
    {
        public StrategyAgribusinessRatingReq RFl { get; set; }
        public StrategyAgribusinessRatingReq AAFML { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class StrategyAgribusinessRatingReq
    {
    ...
    public class OperationAgribusinessReq
    {
        public OperationAgribusinessRatingReq RFl { get; set; }
        public OperationAgribusinessRatingReq AAFML { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class OperationAgribusinessRatingReq
    {
    ...
    public class FinancialAgribusinessReportingReq
    {
        public FinacialAgribusinessRatingReq RFl { get; set; }
        public FinacialAgribusinessRatingReq AAFML { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }
    }

    public class FinacialAgribusinessRatingReq
    {
    ...
    public class ComplianceAgribusinessReq
    {
        public ComplianceAgribusinessRatingReq RFl { get; set; }
        public ComplianceAgribusinessRatingReq AAFML { get; set; }
        [RegularExpression("^[a-zA-Z0-9]*$", ErrorMessage = "Only alphanumeric characters are allowed.")]
        public string? Comment { get; set; }

    }

    public class ComplianceAgribusinessRatingReq
    {
    ...
    public class TimeSinceLastAgribusinessAuditReq
    {
