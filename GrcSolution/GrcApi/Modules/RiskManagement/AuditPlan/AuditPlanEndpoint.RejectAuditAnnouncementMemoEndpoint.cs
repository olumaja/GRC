...
namespace Arm.GrcApi.Modules.RiskManagement.AuditPlan
{
  ...
  */
    public class RejectAuditAnnouncementMemoEndpoint
    {
        ...
        public static async Task<IResult> HandleAsync(
            [FromBody] RejectAuditAnnouncementMemoRequest payload, IRepository<AuditAnnouncementMemoAuditExecution> auditmemo, 
        ...
        )
        {
            try
            {
                ...
                var getAuditAnnouncementMemo = auditmemo.GetContextByConditon(x => x.CommenceEngagementAuditexecutionId == getCommenceEng.Id && x.Team == payload.Team && x.Status != BusinessRiskRatingStatus.Approved).FirstOrDefault();
                ...
                if (getAuditAnnouncementMemo != null)
                {
                    getAuditAnnouncementMemo.RejectAuditAnnouncementMemoStatus(payload.Reason);
                    ...
                    string bodyOfficer = $"Dear {getAuditAnnouncementMemo.RequesterName},.<br> {requesterName} has rejected the Audit Announcement Memo for {getAuditAnnouncementMemo.Unit} {getAuditAnnouncementMemo.Recommendation}, for your review and approval.<br><br>Please click the following link <a href={linkToGRCTool}>GRC link</a> to view the assessment.<br><br>Thank you";
    ...
    public record RejectAuditAnnouncementMemoRequest(Guid CommenceEngagementId, string Reason, string Team);

    public class RejectAuditAnnouncementMemoRequestValidation : AbstractValidator<RejectAuditAnnouncementMemoRequest>
    {
        public RejectAuditAnnouncementMemoRequestValidation()
        {
