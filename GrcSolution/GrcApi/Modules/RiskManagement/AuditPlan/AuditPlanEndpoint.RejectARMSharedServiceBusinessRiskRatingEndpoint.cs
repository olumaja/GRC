...
namespace Arm.GrcApi.Modules.RiskManagement.AuditPlan
{
     ...
     */
    public class RejectARMSharedServiceBusinessRiskRatingEndpoint
    {
        ...
        /// <returns></returns>
        public static async Task<IResult> HandleAsync(Guid businessriskratingId, IRepository<ARMSharedServiceRating> repo,
