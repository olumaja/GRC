...
*/
    public class ViewArmSecurityAudiPlanExecutionOfficerByIdEndpoint
    {
            ...
            IRepository<CommenceEngagementAuditexecution> commenceEng, ClaimsPrincipal user, ICurrentUserService currentUserService)
        {
            try
            {
                ...
                var engagementPlanSTO = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanSTO = getCommenceEngSTO.EngagementPlan.ToString();
                ...
                {                   
                    StockBroking = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanSTO,
