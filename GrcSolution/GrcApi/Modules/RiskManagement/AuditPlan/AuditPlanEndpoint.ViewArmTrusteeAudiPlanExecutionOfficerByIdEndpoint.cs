...
namespace GrcApi.Modules.RiskManagement.AuditPlan
{
   ...
   */
    public class ViewArmTrusteeAudiPlanExecutionOfficerByIdEndpoint
    {
        /// <summary>
        ...
        public static async Task<IResult> HandleAsync(Guid anualAuditUniverseId, IRepository<AnualAuditUniverseRiskRating> annualaudit,
            IRepository<ARMTrusteeAuditUniverse> req, IRepository<AuditUniverseARMTrusteePrivateTrust> privateTrust, IRepository<AuditUniverseARMTrusteeCommercialTrust> commercialTrust,
            ICurrentUserService currentUserService, IRepository<CommenceEngagementAuditexecution> commenceEng,
            ClaimsPrincipal user)
        {
            try
            {
                ...
                var getCommenceEng = commenceEng.GetContextByConditon(x => x.AnualAuditUniverseRiskRatingId == getAuditRating.AnualAuditUniverseRiskRatingId  && x.Team == "Private Trust").FirstOrDefault();
                ...
                var engagementPlanCOM = BusinessRiskRatingStatus.Pending.ToString();
                ...
                {
                    engagementPlanCOM = getCommenceEngCOM.EngagementPlan.ToString();
                ...
                ViewARMTrusteeAudiPlanExecutionByIdResp resp = new ViewARMTrusteeAudiPlanExecutionByIdResp
                {
                    ...
                    CommercialTrust = new ViewAudiPlanExecutionResponse
                    {
                        ...
                        EngagementPlan = engagementPlanCOM,
