...
namespace Arm.GrcApi.Modules.RiskManagement.AuditPlan
{
     ...
     */
    public class ViewARMCapitalAudiPlanExecutionOfficerByIdEndpoint
    {
        /// <summary>
        ...
        public static async Task<IResult> HandleAsync(Guid anualAuditUniverseId, IRepository<AnualAuditUniverseRiskRating> dfsAnnualaudit,
            IRepository<ARMCapitalAuditUniverse> dfsReq, IRepository<AuditUniverseARMCapitalRating> dfsRating, IRepository<CommenceEngagementAuditexecution> commenceEng,
            ClaimsPrincipal user, ICurrentUserService currentUserService)
        {
            try
            {
                ...
                var getCommenceEng = commenceEng.GetContextByConditon(x => x.AnualAuditUniverseRiskRatingId == getAuditRating.AnualAuditUniverseRiskRatingId && x.Team == "ARMCapital").FirstOrDefault();
                ...
                var gettamRating = dfsRating.GetContextByConditon(x => x.ARMCapitalAuditUniverseId == getAuditRating.Id).FirstOrDefault();
