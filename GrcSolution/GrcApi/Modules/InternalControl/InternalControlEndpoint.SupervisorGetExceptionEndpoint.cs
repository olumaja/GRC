...
namespace Arm.GrcApi.Modules.InternalControl
{
     ...
     * Supervisor get all exception for internal control officer
     */
    public class SupervisorGetExceptionEndpoint
    {
        /// <summary>
        /// Supervisor get all exception for internal control officer
        /// </summary>
        ...
        )
        {
            ...
            var exceptions = exRepo.GetContextByConditon(x => x.ExceptionTrackerStatus != ExceptionTrackerStatus.Deleted && x.SupervisorStatus == ExceptionTrackerStatus.Pending_Approval)
