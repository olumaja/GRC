...
namespace Arm.GrcApi.Modules.InternalControl
{
    /*
      ...
      * Get all exception for internal control supervisor
      */
    public class GetAllExceptionForSupervisorEndpoint
    {
        /// <summary>
        ...
        )
        {
            ...
            var exceptions = exRepo.GetContextByConditon(x => x.ExceptionTrackerStatus != ExceptionTrackerStatus.Deleted && x.ExceptionTrackerStatus == ExceptionTrackerStatus.Pending_Approval)
