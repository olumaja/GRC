...
namespace Arm.GrcApi.Modules.InternalControl
{
    /*
      ...
      */
    public class GetAllResolvedExceptionTrackerEndpoint
    {
        /// <summary>
        /// Get all resolved exception for internal control officer
        /// </summary>
        ...
        )
        {
            ...
            var exceptions = exRepo.GetContextByConditon(x => x.ExceptionTrackerStatus == ExceptionTrackerStatus.Resolved)
