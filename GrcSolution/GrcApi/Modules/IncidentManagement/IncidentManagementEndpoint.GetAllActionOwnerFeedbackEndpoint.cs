...
namespace Arm.GrcApi.Modules.IncidentManagement
{
    ...
    * Infosec get all action owner feedback
    */
    public class GetAllActionOwnerFeedbackEndpoint
    {
        /// <summary>
        /// Get all logged mgt
        /// </summary>
        ...
        public static async Task<IResult> HandleAsync(
            ...
            IRepository<LogManagement> repo, IHttpContextAccessor httpContext
        )
        {
            try
            {
                ...
                var logMgt = repo.GetContextByConditon(x => x.Id != default);
                ...
                if (!string.IsNullOrWhiteSpace(search))
                {
                    logMgt = logMgt.Where(d => d.CreatedBy.Contains(search) || d.ReasonForRejection.Contains(search) ||
                        d.EventName.Contains(search) || d.InfoSecRemarks.Contains(search) || d.ActionOwnerRemarks.Contains(search) ||
