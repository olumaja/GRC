...
{
    public class LogRequestDLPEndpoint
    {
        public static async Task<IResult> HandleAsync(LogDLPDto payload, IRepository<DLPLog> DLPRepo, IRepository<LogManagement> logMgtRepo,
        ...
        )
        {
            try
            {
                ...
                var logMgt = LogManagement.CreateLogMgt(
                    LogType.DLP, null, dateAlertWasGenerated: payload.DateAlertWasGenerated, proposeEndDate: payload.ProposedEndDate,
                    status, remark: null, requesterEmail: currentUserService.CurrentUserEmail, actionOwner: payload.ActionOwner, actionOwnerEmailAddress: payload.ActionOwnerEmail,
                ...
                var logDLP = DLPLog.Create(
                    new LogDLPRequest(
                        LogManagementId: logMgt.Id,
                        DLPPolicy: payload.DLPPolicy,
                        DLPRuleMatched: payload.DLPRuleMatched,
                        DLPRuleAction: payload.DLPRuleAction,
                        ActionTaken: payload.ActionTaken,
                        ResponsibleStaff: payload.ResponsibleStaff
                ));

                logDLP.SetCreatedBy(currentUserService.CurrentUserFullName);
                logDLP.SetModifiedBy(currentUserService.CurrentUserFullName);
                logDLP.SetModifiedOnUtc(DateTime.Now);
                DLPRepo.Add(logDLP);
                DLPRepo.SaveChanges();
                ...
                string subject = $"DLP Log Assigned - Action Required";
                ...
                string body = $"Dear {config["EmailConfiguration:CISOName"]}, <br><br>This is to notify you that a new DLP policy has been logged into the GRC Tool as of {DateTime.Now}.<br><br>Details of the Log:<br><br> <strong>Policy Name</strong>:- {payload.DLPPolicy}.<br><br><strong>Submitted By</strong>:- {currentUserService.CurrentUserFullName}.<br><br><strong>Description</strong>:- {payload.DLPRuleAction}.<br><br>Click here <a href={linkToGRCTool}>GRC link</a> to view full log report.<br><br>Best regards.";
                ...
                if (payload.ActionOwner != null)
                {
                    ...
                    body = $"Dear {payload.ActionOwner}, <br><br>A new security log has been assigned to you in the GRC Tool. Please review and work on the recommendation stated. Please see below the summary of the log:<br> <strong>Policy Name</strong>:- {payload.DLPPolicy}.<br><br><strong>Source</strong>:- DLP.<br><br><strong>Description</strong>:- {payload.DLPRuleAction}.<br><br><strong>Due Date</strong>:- {payload.ProposedEndDate}.<br><br> Please log into the GRC tool, review the details, and share remark of the status of this log as you progress.<br><br>Please click here <a href={linkToGRCTool}>GRC link</a> to access the tool.<br><br>If you believe this was assigned to you in error or need further clarification, please reach out to the Information Security Team.<br><br>Best regards.";
                }
