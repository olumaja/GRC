...
namespace Arm.GrcApi.Modules.IncidentManagement
{
    ...
    )
    {
        ...
        public static ValueTask<LogDAMDto> BindAsync(HttpContext httpContext, ParameterInfo parameter)
        {
    ...
    public class LogDAMDtoValidator : AbstractValidator<LogDAMDto>
    {
        public LogDAMDtoValidator()
        {
    ...
    public record DAMRequest(
        ...
        string MaliciousReputation, string EventId, string Observation, string UserAuthorized, string SecurityTool
    );
