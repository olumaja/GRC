...
namespace GrcApi.Modules.AntivirusAssessment
{
    /*
     ...
     */
    public class InfosecReviewActionOwnerFeedbackpoint
    {
        /// <summary>
        ...
        )
        {
            try
            {
                var antiVirus = repo.GetContextByConditon(x => x.AntivirusStatus == AntivirusStatus.Completed || x.AntivirusStatus == AntivirusStatus.Awaiting_Validation);
